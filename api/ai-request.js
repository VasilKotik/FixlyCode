...
app.post(['/', '/api/ai-request'], validateRequest, async (req, res) => {
  ...
  "explanation": "Додано обробку випадку, коли x дорівнює нулю. Тепер функція коректно обробляє всі можливі значення.",
  "tip": "Завжди перевіряйте крайові випадки при написанні умовних операторів.",
  "score": 75,
  "smells": ["Відсутня обробка крайових випадків", "Недостатня перевірка вхідних даних"]
}`
            },
            'ru': {
                ...
                fullExample: `{
  "fixedCode": "if (x > 0) { return x * 2; } else if (x === 0) { return 0; } else { return null; }",
  "explanation": "Добавлена обработка случая, когда x равно нулю. Теперь функция корректно обрабатывает все возможные значения.",
  "tip": "Всегда проверяйте граничные случаи при написании условных операторов.",
  "score": 75,
  "smells": ["Отсутствует обработка граничных случаев", "Недостаточная проверка входных данных"]
}`
            },
            'pl': {
  ...
  "smells": ["Missing edge case handling", "Insufficient input data validation"]
        ...
        // Create separate system message with strong language enforcement and examples
...
📋 EXAMPLE OF CORRECT OUTPUT FORMAT (${targetLangName}):
...
🚫 FINAL REMINDER: If you write ANY text in English in explanation, tip, or smells fields, your response is INCORRECT and will be rejected. Use ${targetLangName} ONLY. Follow the example above exactly.`;
